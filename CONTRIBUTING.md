...
Major version of OpenVPN, or Go that changes behavior, must reflect a change in MINOR number. Patch number is reflecting in a change in this repository such as bug fix or feature request.
